...
int HH_OSD_SetOsdPosDefault(int chn,int mode,int bigshow);
...
{
	HH_OSD_CTRL_ST	stDateOSD;				// 0:不叠加时间,   1:叠加时间
	HH_OSD_CTRL_ST	stTimeOSD;				// 0:不叠加日期,   1:叠加日期
