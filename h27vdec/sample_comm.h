...
{
    VIDEO_DEC_MODE_E enDecMode;					//定义解码枚举    1 i p b劝解吗   2 i p解码   i 模式  只解码I帧  
    HI_U32              u32RefFrameNum;
    DATA_BITWIDTH_E  enBitWidth;				//定义数据宽度枚举   8bit  10bit   12bit。。。   
