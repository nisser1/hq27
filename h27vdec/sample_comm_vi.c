...
////add bt1120
VI_PIPE_ATTR_S PIPE_ATTR_BT1120_1920_1080_420_3DNR_RFR =
{
...
//add bt1120
VI_CHN_ATTR_S CHN_ATTR_BT112_1920x1080LINEAR =
{
    {1920, 1080},
    PIXEL_FORMAT_YVU_SEMIPLANAR_420,
    DYNAMIC_RANGE_SDR8,
...
static input_mode_t SAMPLE_COMM_VI_GetSnsInputMode(SAMPLE_SNS_TYPE_E enSnsType)
{
    ...
    switch (enSnsType)
    {
        ...
        case SONY_IMX277_SLVS_2M_240FPS_12BIT:
            ...
            break;
		case HT706_XMC_BT1120_30FPS_12BIT:
			enInputMode = INPUT_MODE_BT1120;
			break;
        default:
...
HI_S32 SAMPLE_COMM_VI_GetComboAttrBySns(SAMPLE_SNS_TYPE_E enSnsType, combo_dev_t MipiDev, combo_dev_attr_t* pstComboAttr)
{
    switch (enSnsType)
    {
        ...
        case SONY_IMX477_MIPI_8M_60FPS_12BIT:
            ...
            {
                hi_memcpy(pstComboAttr, sizeof(combo_dev_attr_t), &MIPI_4lane_CHN6_SENSOR_IMX477_10BIT_8M_NOWDR_ATTR, sizeof(combo_dev_attr_t));
            }
            else
            {
                SAMPLE_PRT("unsupported mipi dev :%d for SnsType :%d\n",MipiDev, enSnsType);
        ...
        case SONY_IMX477_MIPI_8M_30FPS_12BIT:
            ...
            {
                hi_memcpy(pstComboAttr, sizeof(combo_dev_attr_t), &MIPI_4lane_CHN6_SENSOR_IMX477_12BIT_8M_NOWDR_ATTR, sizeof(combo_dev_attr_t));
            }
            else
            {
                SAMPLE_PRT("unsupported mipi dev :%d for SnsType :%d\n",MipiDev, enSnsType);
        ...
        case SONY_IMX290_MIPI_2M_30FPS_12BIT:
            ...
            {
                hi_memcpy(pstComboAttr, sizeof(combo_dev_attr_t), &MIPI_4lane_CHN4_SENSOR_IMX290_12BIT_2M_NOWDR_ATTR, sizeof(combo_dev_attr_t));
            }
            else
            {
                SAMPLE_PRT("unsupported mipi dev :%d for SnsType :%d\n",MipiDev, enSnsType);
	...
	case SONY_IMX334_MIPI_8M_30FPS_12BIT:
            ...
            {
                hi_memcpy(pstComboAttr, sizeof(combo_dev_attr_t), &MIPI_4lane_CHN2_SENSOR_IMX334_12BIT_8M_NOWDR_ATTR, sizeof(combo_dev_attr_t));
            }
            else if (4 == MipiDev)
            {
                hi_memcpy(pstComboAttr, sizeof(combo_dev_attr_t), &MIPI_4lane_CHN4_SENSOR_IMX334_12BIT_8M_NOWDR_ATTR, sizeof(combo_dev_attr_t));
            }
            else if (6 == MipiDev)
            {
                hi_memcpy(pstComboAttr, sizeof(combo_dev_attr_t), &MIPI_4lane_CHN6_SENSOR_IMX334_12BIT_8M_NOWDR_ATTR, sizeof(combo_dev_attr_t));
            }
            else
            {
                SAMPLE_PRT("unsupported mipi dev :%d for SnsType :%d\n", MipiDev, enSnsType);
	...
	case SONY_IMX334_MIPI_8M_30FPS_12BIT_WDR2TO1:
            ...
            {
                hi_memcpy(pstComboAttr, sizeof(combo_dev_attr_t), &MIPI_4lane_CHN2_SENSOR_IMX334_12BIT_8M_WDR2to1_ATTR, sizeof(combo_dev_attr_t));
            }
            else if (4 == MipiDev)
            {
                hi_memcpy(pstComboAttr, sizeof(combo_dev_attr_t), &MIPI_4lane_CHN4_SENSOR_IMX334_12BIT_8M_WDR2to1_ATTR, sizeof(combo_dev_attr_t));
            }
            else if (6 == MipiDev)
            {
                hi_memcpy(pstComboAttr, sizeof(combo_dev_attr_t), &MIPI_4lane_CHN6_SENSOR_IMX334_12BIT_8M_WDR2to1_ATTR, sizeof(combo_dev_attr_t));
            }
            else
            {
                SAMPLE_PRT("unsupported mipi dev :%d for SnsType :%d\n", MipiDev, enSnsType);
        ...
        case SONY_IMX277_SLVS_2M_240FPS_12BIT:
            ...
            break;
		case HT706_XMC_BT1120_30FPS_12BIT:
			hi_memcpy(pstComboAttr, sizeof(combo_dev_attr_t), &MIPI_BT1120_ATTR, sizeof(combo_dev_attr_t));
            break;
        default:
...
HI_S32 SAMPLE_COMM_VI_SetMipiAttr(SAMPLE_VI_CONFIG_S* pstViConfig)
{
    ...
    for (i = 0; i < pstViConfig->s32WorkingViNum; i++)
    {
		...
		printf("stcomboDevAttr.devno,stcomboDevAttr.input_mode, stcomboDevAttr.data_rate, stcomboDevAttr.img_rect.x, stcomboDevAttr.img_rect.y, stcomboDevAttr.img_rect.width, stcomboDevAttr.img_rect.height");
...
HI_S32 SAMPLE_COMM_VI_GetPipeAttrBySns(SAMPLE_SNS_TYPE_E enSnsType, VI_PIPE_ATTR_S* pstPipeAttr)
{
	...
	case SONY_IMX334_MIPI_8M_30FPS_12BIT:
        ...
        case SONY_IMX277_SLVS_2M_240FPS_12BIT:
            ...
            break;
        case HT706_XMC_BT1120_30FPS_12BIT:
            hi_memcpy(pstPipeAttr, sizeof(VI_PIPE_ATTR_S), &PIPE_ATTR_BT1120_1920_1080_420_3DNR_RFR, sizeof(VI_PIPE_ATTR_S));
            break;
...
HI_S32 SAMPLE_COMM_VI_GetChnAttrBySns(SAMPLE_SNS_TYPE_E enSnsType, VI_CHN_ATTR_S* pstChnAttr)
{
	...
	case SONY_IMX334_MIPI_8M_30FPS_12BIT:
        ...
        case SONY_IMX277_SLVS_2M_240FPS_12BIT:
            ...
            break;
		case HT706_XMC_BT1120_30FPS_12BIT:
            hi_memcpy(pstChnAttr, sizeof(VI_CHN_ATTR_S), &CHN_ATTR_BT112_1920x1080LINEAR, sizeof(VI_CHN_ATTR_S));
            break;
...
HI_S32 SAMPLE_COMM_VI_BindPipeDev(SAMPLE_VI_INFO_S* pstViInfo)
{
	...
	printf("syj pstViInfo->stDevInfo.ViDev=%d stDevBindPipe.PipeId[%d]=%d\n",pstViInfo->stDevInfo.ViDev,i, stDevBindPipe.PipeId[i]);
    if (s32Ret != HI_SUCCESS)
    {
